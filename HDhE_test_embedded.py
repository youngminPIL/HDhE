...
def Get_test_results_reid(image_datasets, dataloaders, model, f_size=512):
    feature_size = f_size
    ...
    # Extract feature
    query_feature = extract_feature(model, dataloaders['query'], feature_size)
    gallery_feature = extract_feature(model, dataloaders['gallery'], feature_size)
...
def Get_test_results_inshop(image_datasets, dataloaders, model, f_size=512):
    feature_size = f_size
...
def Get_test_results(image_datasets, dataloaders, model, f_size=512, sop=False):
    feature_size = f_size
...
#     # Extract feature
#     recall_ks = []
#     query_feature = extract_feature(model, dataloaders, i, feature_size)
#
#     sim_mat = pairwise_similarity(query_feature)
#     # sim_mat = pairwise_similarity(query_feature, gallery_feature)
#
